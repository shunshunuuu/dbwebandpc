...
public class ImageHepler
{
            ...
            throws IOException
    {
        ...
        BufferedImage subImage = new BufferedImage(subImageBounds.width, subImageBounds.height,
     ...
     * @throws Exception
     */
    public static Icon getFixedIcon(File srcImageFile,File descDir, int width, int height) throws Exception
    {
        ...
        try
        {
            ImageIO.write((BufferedImage) image, "jpg", descDir);
            ret = new ImageIcon(descDir.getPath());
        }
        catch (Exception e)
        {
            e.printStackTrace();
