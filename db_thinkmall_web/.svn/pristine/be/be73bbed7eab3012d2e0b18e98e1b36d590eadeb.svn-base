...
define(function(require, exports, module) {
	var _pageId = "#finan_productRecPA "; // 页面id
	...
	function productAdvert() {
		...
		// 获取常量类中广告组ID值
		var groupId = constants.advertGroupId.ADVERT_GROUP_ID_PA_product_0;
	...
	function cashbutlerAdvert() {
		...
		// 获取常量类中广告组ID值
		var groupId = constants.advertGroupId.ADVERT_GROUP_ID_PA_product_1;
