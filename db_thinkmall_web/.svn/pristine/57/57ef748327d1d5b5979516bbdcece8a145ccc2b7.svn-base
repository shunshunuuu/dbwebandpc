...
define(function(require, exports, module) {
	var _pageId = "#finan_productRec "; // 页面id
	...
	function productAdvert() {
		...
		// 获取常量类中广告组ID值
		var groupId = constants.advertGroupId.ADVERT_GROUP_ID_SPREAD_BANNER;
	...
	function cashbutlerAdvert() {
		...
		// 获取常量类中广告组ID值
		var groupId = constants.advertGroupId.ADVERT_GROUP_ID_SPREAD_BANNER_0;
	...
	function bindPageEvent() {
		...
		appUtils.bindEvent(_pageId + ".per_btn", function() {
			appUtils.pageInit("finan/productRec", "account/userCenter", {});
			return false;
		});
