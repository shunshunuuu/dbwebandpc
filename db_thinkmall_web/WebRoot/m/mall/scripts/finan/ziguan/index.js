define(function(require, exports, module) {
	var _pageId = "#finan_ziguan_index "; // 页面id
	var pageCode = "finan/ziguan/index";
	...
	function queryziguanProduct(){
		var param = {
				"fina_belongs" : 1, // 产品类型(1.资管)
				"page" : 1, 
				"numPerPage" : 8,
				"product_shelf" : 1
	   };
		...
		service.findFinan(param,function(resultVo){
			if(0==resultVo.error_no){
				...
				var ziguanEle = $(_pageId+"#ziguanlist").empty();
...
//							1资管 2银行理财 5收益凭证 6信托 7私募 8保险 9报价回购
			   ...
			   layerUtils.iAlert("查询资管产品列表失败:"+resultVo.error_info,-1);
			}
		})
	}
	...
	function cashbutlerAdvert() {
		...
		// 获取常量类中广告组ID值
		var groupId = constants.advertGroupId.ADVERT_GROUP_ID_ZG;
