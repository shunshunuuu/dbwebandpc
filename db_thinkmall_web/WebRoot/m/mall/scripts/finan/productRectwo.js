...
define(function(require, exports, module) {
	var _pageId = "#finan_productRectwo "; // 页面id
	...
	function productAdvert() {
		...
		// 获取常量类中广告组ID值
		var groupId = constants.advertGroupId.ADVERT_GROUP_ID_JJ_producttwo_1;
	...
	function cashbutlerAdvert() {
		...
		// 获取常量类中广告组ID值
		var groupId = constants.advertGroupId.ADVERT_GROUP_ID_JJ_producttwo_0;
	...
	function bindPageEvent() {
		//banner图片点击事件
		 appUtils.preBindEvent($(_pageId + "#banner_img"),"a", function(e) {
			    countEvent("金融商城活动页banner图");
		 });
